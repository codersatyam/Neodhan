...
const loanTypes = [
  ...
  },
  {
    ...
    desc: "Grow your business with or without collateral. Competitive rates and easy repayment for entrepreneurs.",
    img: businessLoan,
    number: "02",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    img: personalLoan, // Using personal loan image as placeholder
    number: "06",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
